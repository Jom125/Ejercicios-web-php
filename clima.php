...
$data = json_decode($response, true); // decodifica el json a un array asociativo
...
<head>
    ...
    <style>
        ...
        .card { background: white; padding: 20px; border-radius: 8px; display: inline-block; margin-top: 50px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); }
    </style>
</head>
<body>
    <div class="card">
        ...
        <p><strong>Pronóstico:</strong> <?php echo $data['dataseries'][1]['weather']; ?></p>
